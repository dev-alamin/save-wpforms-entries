...
class Admin_Notice
{
    ...
    {
        add_action('fembefore_entries_ui_header', [$this, 'display_doc_link']);
        add_action('fembefore_entries_ui_header', [$this, 'aem_rest_notice']);

        add_action('admin_notices', [$this, 'rest_disabled_notice']);

        add_filter( 'plugin_action_links_' . FEM_PLUGIN_BASE, [ $this, 'plugin_action_links' ] );
    }
