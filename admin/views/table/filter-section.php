 ...
 <div
     ...
     <div class="flex flex-wrap gap-4 items-center py-4 px-4">
         ...
         <!-- Search Input -->
         <div class="relative  md:w-[400px] sm:w-[300px]">
             <input
                 type="search"
                 aria-label="<?php esc_attr_e('Search entries', 'advanced-entries-manager-for-wpforms'); ?>"
                 class="!w-full !px-2 !py-[2px] !border !border-gray-300 !rounded-lg !text-gray-800 !font-medium
           !focus:outline-none !focus:ring-2 !focus:ring-indigo-500 !transition !hover:border-indigo-500"
             ...
             <div
                 ...
                 <template x-for="(entry, i) in entries" :key="entry.id">
                     <div
                         @click="showEntry(i)"
                         class="!px-4 !py-3 !border-b !border-gray-200 hover:!bg-indigo-50 cursor-pointer text-sm"
                         role="option"
                         tabindex="0"
