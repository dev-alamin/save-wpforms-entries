<div x-data="entriesApp()" x-init="fetchEntries()" class="wrap swpfe-admin-page min-h-screen px-8 py-10 text-[15px] font-inter">
                ...
                <div class="bg-white shadow-md rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <div
                        ...
                        <div class="text-center cursor-pointer select-none flex items-center justify-center gap-1" @click="sortByDate">
                            <span x-text="'<?php echo esc_js(__('Date', 'save-wpf-entries')); ?>'"></span>
                        ...
                        <div class="text-center cursor-pointer select-none flex items-center justify-center gap-1" @click="sortByStatus">
                            <span x-text="'<?php echo esc_js(__('Status', 'save-wpf-entries')); ?>'"></span>
    ...
    <!-- If no data is present, show blank page  -->
